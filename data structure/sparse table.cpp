...
// sparse table data structure // query for , range maximum , minmum , max index, min index and sum query
#include<bits/stdc++.h> 
...
int max_query(int l,int r){
 ...
 // this can be modified for any type of non overlapping query in log(n) time 
